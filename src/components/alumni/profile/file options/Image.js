...
import {UploadAlumniProfilePic,AlumniOwnProfilePic } from '../../../actions/alumni/index'
...
class Image extends Component {
    ...
    componentDidMount() {
        this.props.AlumniOwnProfilePic();
    ...
    uploadFile = () => {
        ...
        this.props.UploadAlumniProfilePic(fd);
    }
    render() {
        if (this.props.profile) {
            let image=new Buffer.from(this.props.profile.pic.data).toString('base64');
...
const mapStateToProps = (state) => {
    return ({ profile: state.AlumniProfile.profilePic})
}

export default connect(mapStateToProps, {UploadAlumniProfilePic, AlumniOwnProfilePic})(Image);