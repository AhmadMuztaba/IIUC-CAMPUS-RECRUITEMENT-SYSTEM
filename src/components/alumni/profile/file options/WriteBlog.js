...
import {CreateAlumniBlog} from '../../../actions/alumni/index';
...
class WriteBlog extends Component {
    ...
    HandleSubmit = (e) => {
        ...
        this.props.CreateAlumniBlog(fd);
    }
    render() {
        return (
            <div className="show-Dashboard">
                ...
                <div className="textAreaAndButtonWrapper">
                    ...
                    <input type="file" required="true" style={{ display: 'none' }} ref={(file) => this.file = file} name="file" onChange={(e) => {
...
export default connect(null, {CreateAlumniBlog})(WriteBlog);