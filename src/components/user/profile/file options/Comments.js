...
import {fetchUserBlogComments,CreateUserBlogCommentByUsers} from '../../../actions/user/index';
...
const Comments = (props) => {
   ...
   <div className="userBlog-comment">
           <form onSubmit={(e)=>{
               e.preventDefault();
               props.CreateUserBlogCommentByUsers(props.params,state.comment);
               setState({comment:''});
           }}>
...
export default connect(mapStateToProps,{fetchUserBlogComments,CreateUserBlogCommentByUsers})(Comments);