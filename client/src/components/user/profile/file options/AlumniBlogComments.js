...
import {fetchAlumniBlogComments,CreateAlumniBlogCommentByUsers} from '../../../actions/user/index';
...
const AlumniBlogComments = (props) => {
   ...
   <div className="userBlog-comment">
           <form onSubmit={(e)=>{
               e.preventDefault();
               props.CreateAlumniBlogCommentByUsers(props.params,state.comment);
               setState({comment:''});
           }}>
...
export default connect(mapStateToProps,{fetchAlumniBlogComments,CreateAlumniBlogCommentByUsers})(AlumniBlogComments);