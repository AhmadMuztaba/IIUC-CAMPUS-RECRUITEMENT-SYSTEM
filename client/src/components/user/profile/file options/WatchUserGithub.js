...
import {UserWatchAlumniGithubRep} from '../../../actions/user/index';
class WatchUserGithub extends Component {
    componentDidMount() {
        this.props.UserWatchAlumniGithubRep(this.props.id);
    }
    render() {
...
export default connect(mapStateToProps,{UserWatchAlumniGithubRep})(WatchUserGithub);