...
import {watchAlumnigithubrating} from '../../../actions/admin/index';
class WatchUserGithub extends Component {
    componentDidMount() {
        this.props.watchAlumnigithubrating(this.props.id);
    }
    render() {
...
export default connect(mapStateToProps,{watchAlumnigithubrating})(WatchUserGithub);