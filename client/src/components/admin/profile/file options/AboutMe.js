...
class AboutMe extends React.Component {
    ...
    render() { 
        ...
        return (<div className="show-Dashboard">
            ...
            <h2>
                {this.props.ownProfile.userProfile.skills.map((skill, index) => {
                    let e = "";
                    if (index > 0) {
                        e = " , "
                    }
            ...
            <div className="professional-info" >
                <div style={{ height: `${this.state.height}px`, borderRight: '1px solid #e0e0dc', verticalAlign: 'center', marginBottom: '80px' }}>
                    <ul ref={this.sidelineRef}>
                        ...
                        {this.props.ownProfile.userProfile.status ? <li><h4>Status</h4></li> : null}
                ...
                <div>
                    <ul>
                        ...
                        {this.props.ownProfile.userProfile.status ? <li><h4>{this.props.ownProfile.userProfile.status}</h4></li> : null}
